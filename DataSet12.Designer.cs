...
namespace Proje2net.DataSet12TableAdapters {
    ...
    public partial class TBLADMINTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["Proje5AdminConnectionString"].ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT * FROM TBLADMIN WHERE ID=@ID";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@ID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "ID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "UPDATE TBLADMIN SET KULLANICI=@KULLANICI,SIFRE=@SIFRE WHERE ID=@ID";
            ...
            this._commandCollection[3].CommandText = "DELETE From TBLADMIN WHERE ID=@ID";
        ...
        public virtual int Fill(DataSet12.TBLADMINDataTable dataTable) {
        ...
        public virtual DataSet12.TBLADMINDataTable AdminListesi() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet12.TBLADMINDataTable dataTable = new DataSet12.TBLADMINDataTable();
        ...
        public virtual int FillBy(DataSet12.TBLADMINDataTable dataTable, int ID) {
        ...
        public virtual DataSet12.TBLADMINDataTable VeriGetir(int ID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(ID));
            DataSet12.TBLADMINDataTable dataTable = new DataSet12.TBLADMINDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet12.TBLADMINDataTable dataTable) {
        ...
        public virtual int Kisigüncelle(string KULLANICI, string SIFRE, int ID) {
        ...
        public virtual int Kisisil(int ID) {
